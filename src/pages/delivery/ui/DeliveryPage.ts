    ...
    <div class="px-4 py-20 md:px-6 lg:px-30 max-w-360 mx-auto flex flex-col gap-4">
      ...
      <section class="bg-background-secondary rounded-2xl p-6 sm:p-10 lg:p-12">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
          ${PayCard('cash.png', 'Оплата наличными', 'Оплатить товар наличными вы можете как в магазине, так и при доставке на дом — у наших курьеров всегда есть сдача. Перед тем как расплатиться, у вас есть возможность удостовериться в качестве устройства.')}
          ${PayCard('card.png', 'Банковской картой в магазине / курьеру', 'Неважно, забираете ли вы товар сами из магазина или заказали доставку — в любом случае вы можете расплатиться таким способом, ведь у наших курьеров всегда есть терминалы.')}
          ${PayCard('online.png', 'Онлайн оплата +8% комиссия', 'Оплата через платёжную систему на сайте при помощи банковской карты, Яндекс Деньги, WebMoney и др. Обратите внимание, комиссия зависит от способа оплаты.')}
        </div>

        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ${PayCard('checkmark.png', 'Безналичный расчёт', 'Мы всегда действуем в интересах покупателей, поэтому предоставляем возможность оплатить товар безналичным расчётом. Обратитесь к нашим менеджерам по телефону +7 (812) 704-86-97, чтобы получить всю необходимую информацию.')}
          ${PayCard('bank.png', 'Кредит', 'Иногда желание стать владельцем гаджета не совсем совпадает с возможностью сразу оплатить всю сумму. Мы сотрудничаем со многими банками — оформление кредита происходит очень быстро. Звоните: +7 (812) 704-86-97.')}
        </div>
      </section>
