...
export const Advantages = ({ className = '' }: AdvantagesProps = {}) => {
  const advantages: AdvantageCardProps[] = [
    {
      icon: '/src/pages/home/sections/advantages/assets/discount-emoji.png',
    ...
    {
      icon: '/src/pages/home/sections/advantages/assets/wallet-emoji.png',
    ...
    {
      icon: '/src/pages/home/sections/advantages/assets/delivery-emoji.png',
    ...
    {
      icon: '/src/pages/home/sections/advantages/assets/bank-emoji.png',
    ...
    {
      icon: '/src/pages/home/sections/advantages/assets/approval-emoji.png',
      title: 'Гарантия',
